        ...
        <div class="mt-20 max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 sm:flex-row sm:mt-0">
            <div  class="flex flex-col justify-center h-full">
                ...
                <span   class="cursor inline ml-1 w-1">&nbsp;</span>
                    ...
                    <p v-motion-slide-visible-left class="duration-500 text-gray-500 py-4 max-w-md">
                    ...
                    <div>
                        <button v-motion-slide-visible-bottom @click="scroll('project')" class="group text-white w-fit px-6 py-3 my-2 items-center rounded-md bg-gradient-to-r from-cyan-500 to-blue-500">
                            Portfolio 
                ...
                <div>
                    <img v-motion-slide-visible-right :src="HeroImage" alt="" class="duration-500 hidden md:block mx-auto w-2/3 sm:w-full">
                </div>
